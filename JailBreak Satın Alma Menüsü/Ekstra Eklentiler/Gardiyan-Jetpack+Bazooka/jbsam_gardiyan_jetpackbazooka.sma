...
public plugin_init() {
	...
	cvar_esya_para = register_cvar("jbsam_jb_ucret","30")
	esya = jbsam_esya_gir("Jetpack+Bazooka", get_pcvar_num(cvar_esya_para), "Tek Roundluk", GARDIYAN)
...
public jbsam_esya_sec(player, item){
	if(item != esya)
		return PLUGIN_HANDLED
	new clip,ammo
