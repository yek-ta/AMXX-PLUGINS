...
Scheme
{
	...
	Colors
	{
		...
		// Informations from the tutordata.txt
		// There are many kinds of types for a tutor message.
		//      - Default: If the type of a message not set or invalid the message will be set to default. Called for some player instructions. (Info)
		//      - FriendDeath (TutorTextClass2): Called if a friend died (Skull)
		//      - EnemyDeath (TutorTextClass4): Called if an enemy died (Skull)
		//      - Scenario (TutorTextClass8): Called for some informations about objectives (Info)
		//      - Buy (TutorTextClass16): Called for some informations about buymenu (Info)
		//      - Career (TutorTextClass32): Called for some informations about career (Info)
		//      - Hint (TutorTextClass64): (Info)
		//      - InGameHint (TutorTextClass128): (Info)
		//      - EndGame (TutorTextClass256): (Info)
		// Not all types are listed in the original TutorScheme.res (for example Buy, Career, Hint). 
		// This types get usually the color of default type but we add this types, so you can choose the color of this types.
		"TutorTextClassDefault"	"28 207 61 255"	// default: 28 207 61 255
		"TutorTextClass2"		"255 38 38 255"	// default: 255 38 38 255
		"TutorTextClass4"		"38 149 253 255"	// default: 38 149 253 255
		"TutorTextClass8"		"255 227 38 255"	// default: 255 38 38 255
		"TutorTextClass16"		"255 0 110 255"	// Class added! default: 28 207 61 255
		"TutorTextClass32"		"255 123 0 255"	// Class added! default: 28 207 61 255
		"TutorTextClass64"		"0 255 255 255"	// Class added! default: 28 207 61 255
		"TutorTextClass128"	"178 0 255 255"	// Class added! default: 28 207 61 255
		"TutorTextClass256"	"255 255 255 255"	// default: 255 38 38 255
	}
